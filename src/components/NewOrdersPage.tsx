...
const ORDERS: Order[] = [
  {
    ...
    humanAction: 'Approve',
    humanStatus: 'Quote awaiting Spend Watchdog approval',
    humanDescription: 'Sashimi-grade for Stake, food-grade for BC, prawns split across three venues.',
    eta: 'May 17 · 11:00', dagStage: 1,
    agentReasoning: "Quote 4% below the 30-day median. Cold-chain SLA 98%. Combined drop reuses one cold-chain run. Sits above the auto-approve cap (Rp 12M), so needs your approval.",
  ...
  },
  {
    ...
    agentReasoning: "Restock Agent flagged par floor breach this morning. A-02 promoted to Rush playbook. AUS Premium Meats is your contracted Wagyu vendor — quote within 12% Rush premium tolerance. USD 1,840 locked at 15,490.",
  ...
  },
  {
    ...
    humanStatus: 'Disputed — quote 18% above market',
    humanDescription: 'Splash Saturday event needs takeaway boxes; quote flagged by Spend Watchdog. Dispute open in Activity & Governance.',
    eta: 'May 18 · 14:00', dagStage: 1,
    agentReasoning: "Quote 18% above 30-day median. A-04 held under RUL-001 (Spend Cap, vendor scope). No alternative vendor carries the 1000ml SKU. F&B Director raised dispute DSP-101 to accept the premium.",
  ...
  },
  {
    ...
    agentReasoning: "Delivered. A-05 awaiting QC sign-off at BC kitchen receiving bay. Burrata batch needs a visual check before stock release.",
    agentAgent: 'A-05 (Logistics)',
    assignedAgent: { id: 7, role: 'Logistics' },
  ...
  },
  {
    ...
    agentReasoning: "Cleared Tanjung Priok customs. Logistics coordinating last-mile with cold-chain handler. USD 2,710 locked at 15,500.",
    agentAgent: 'A-05 (Logistics)',
    assignedAgent: { id: 7, role: 'Logistics' },
  ...
  },
  {
    ...
    agentReasoning: "Recurring weekly produce — A-04 auto-approved under standing recurring schedule. QC pass. Stock auto-incremented.",
    agentAgent: 'A-02 (Restock)',
    assignedAgent: { id: 8, role: 'Restock' },
