...
const ORDERS: Order[] = [
  {
    id: 'PO-2855', supplier: 'AUS Meats Pty',
    items: ['Beef Tenderloin 30kg', 'Lamb Rack 20kg', 'Chicken Breast 50kg'],
    amount: 8900, group: 'needs-action', actionKind: 'approve',
    humanAction: 'Approve',
    ...
    isNewSupplier: true,
    digitalTwin: {
      switchSaving: 'Rp 4.2M/month',
      leadTimeDelta: '+2 days',
      recommendation: 'Switching to AUS Meats reduces food costs by Rp 4.2M/month but adds 2 days lead time. Approve if buffer stock covers the gap.',
    },
  ...
  {
    id: 'PO-2857', supplier: 'Indo Seafood',
    items: ['Tiger Prawns 25kg', 'Squid 30kg'],
    amount: 4100, group: 'needs-action', actionKind: 'resolve-issue',
    humanAction: 'Resolve Issue',
    humanStatus: 'Delivery failed — rescheduling',
  ...
  {
    id: 'PO-2847', supplier: 'PT Maju Bersama',
    items: ['Rice 500kg', 'Cooking Oil 200L'],
    amount: 12400, group: 'needs-action', actionKind: 'confirm-delivery',
    humanAction: 'Confirm Delivery',
    humanStatus: 'Arriving now — confirm receipt',
  ...
  {
    id: 'PO-2851', supplier: 'Thai Fresh Co',
    items: ['Chicken Breast 80kg', 'Fish Sauce 40L'],
    amount: 3200, group: 'autonomous',
    humanAction: '',
    humanStatus: 'Almost here — 10 minutes out',
  ...
  {
    id: 'PO-2853', supplier: 'VN Supply Ltd',
    items: ['Coffee Beans 100kg', 'Mixed Spices 30kg'],
    amount: 5600, group: 'autonomous',
    humanAction: '',
  ...
  {
    id: 'PO-2830', supplier: 'PT Maju Bersama',
    items: ['Rice 400kg', 'Cooking Oil 150L'],
    amount: 9800, group: 'autonomous',
    humanAction: '',
    humanStatus: 'Delivered · Apr 5',
    ...
    completedAt: '2026-04-05T11:20:00.000Z',
    status: 'live',
    workflowTemplate: 'WF-BPO',
  },
  {
    id: 'PO-2828', supplier: 'Thai Fresh Co',
    items: ['Coconut Milk 120 cans', 'Curry Paste 50kg'],
    amount: 2100, group: 'autonomous',
    humanAction: '',
    humanStatus: 'Delivered · Apr 3',
    ...
    completedAt: '2026-04-03T14:10:00.000Z',
    status: 'live',
    workflowTemplate: 'WF-STD',
  },
];
...
const HISTORICAL_AGENTS: AssignedAgent[] = [
  { id: 7,  role: 'Logistics' },
  { id: 5,  role: 'Vendor Comms' },
  { id: 13, role: 'Exception Handler' },
  { id: 28, role: 'Payments' },
  { id: 33, role: 'Compliance' },
  { id: 9,  role: 'Quality' },
  { id: 18, role: 'ERP' },
];

const HISTORICAL_SUPPLIERS: string[] = [
  'AUS Meats Pty', 'Indo Seafood', 'PT Maju Bersama', 'Thai Fresh Co', 'VN Supply Ltd',
  'Metro Bakehouse', 'Fresh Valley Farms', 'Premium Dairy Direct', 'Urban Greens Collective',
  'Alpine Cheese Factory', 'Seafood Masters Inc', 'City Spice Co', 'Bali Fresh Farms',
  'Oceanic Harvest', 'PT Sumber Daging', 'PH Agri Corp',
];

const HISTORICAL_ITEMS: string[][] = [
  ['Beef Tenderloin 25kg', 'Lamb Rack 15kg'],
  ['Tiger Prawns 20kg', 'Salmon Fillet 15kg'],
  ['Rice 400kg', 'Cooking Oil 150L'],
  ['Chicken Breast 60kg'],
  ['Coffee Beans 80kg', 'Mixed Spices 25kg'],
  ['Sourdough Loaves 120 units', 'Brioche Buns 200 units'],
  ['Heritage Tomatoes 40kg', 'Baby Spinach 20kg'],
  ['Full-Fat Milk 200L', 'Butter 50kg', 'Yogurt 80kg'],
  ['Mixed Salad Greens 30kg', 'Herbs 8kg'],
  ['Comté 15kg', 'Brie 20kg', 'Goat Cheese 10kg'],
  ['Atlantic Cod 25kg', 'Scallops 12kg'],
  ['Cardamom 10kg', 'Star Anise 8kg', 'Black Pepper 20kg'],
  ['Bell Peppers 15kg', 'Cherry Tomatoes 20kg'],
  ['Sea Bass 18kg', 'Mackerel 25kg'],
  ['Beef Brisket 30kg', 'Pork Shoulder 25kg'],
  ['Coconut Milk 80 cans', 'Pandan Leaves 5kg'],
];
